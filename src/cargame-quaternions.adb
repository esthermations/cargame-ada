--  copied wholesale from OpenGLAda/examples/common/quaternions.adb
with Ada.Numerics.Generic_Elementary_Functions;

package body Cargame.Quaternions is
      ...
      return
        (A =>
         ...
         B =>
           ...
           Left.D * Right.C,
         C =>
           Left.A * Right.C - Left.B * Right.D + Left.C * Right.A +
           Left.D * Right.B,
         D =>
   ...
   begin
      return
        Real'Image (Left.A) & " +" & Real'Image (Left.B) & "i +" &
        Real'Image (Left.C) & "j +" & Real'Image (Left.D) & "k";
   end Image;
   ...
   begin
      Norm :=
        Sqrt
          (Left.A * Left.A + Left.B * Left.B + Left.C * Left.C +
           Left.D * Left.D);
      NQ.A := Left.A / Norm;
      NQ.B := Left.B / Norm;
      NQ.C := Left.C / Norm;
